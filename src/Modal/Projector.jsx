...
import footprint from '../Image/footprint.jpg'

const Projector = ({ open, onClose }) => {
  if (!open) return null;
  return (
    <div onClick={onClose} className='fixed w-full h-full z-20 top-1/2'>
      ...
      >
        {/* <img src={footprint} className="md:w-[250px] w-[150px] object-cover" /> */}
        <div className='w-full'>
          ...
          <div className='flex flex-col justify-center text-center mt-[3rem] py-[1rem] md:px-[2rem]'>
            <p className='md:text-2xl font-noto-sans'>投影機投影電腦輸出畫面至對面牆面上</p>
          </div>
        </div>
      </div>
    </div>
